...
public class MergeSortStrategyTest {
    ...
    public void testSort_ShouldSortListCorrectly() {
        MergeSortStrategy strategy = new MergeSortStrategy(10);
    ...
    public void testSort_ShouldThrowExceptionWhenListTooLarge() {
        MergeSortStrategy strategy = new MergeSortStrategy(3);
        ...
        String expectedMessage = "List size exceeds the limit for Merge Sort.";
    ...
    public void testGetStrategyName_ShouldReturnCorrectName() {
        MergeSortStrategy strategy = new MergeSortStrategy(10);
        assertEquals("Merge Sort", strategy.getStrategyName());
    }
